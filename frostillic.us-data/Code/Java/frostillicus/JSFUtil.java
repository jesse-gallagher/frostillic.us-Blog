...
public class JSFUtil {
	...
	public static Database findProjectDatabase(final String projectDocumentUNID) throws NotesException {
	...
	public static Database findProjectDatabase(final Document projectDoc) throws NotesException {
		Database db;
	...
	public static Document getReportDocument(final String reportName) throws NotesException {
	...
	@SuppressWarnings("unchecked")
	public static String iterableToSQL(final Iterable input) {
	...
	@SuppressWarnings("unchecked")
	public static boolean isDocEditableBy(final Document doc, final String userName) throws NotesException {
